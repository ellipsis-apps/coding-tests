namespace ellipsis.apps.uno.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.companyname.ellipsis-apps-uno";
    public readonly static string AndroidAppName = "com.companyname.ellipsis-apps-uno";
